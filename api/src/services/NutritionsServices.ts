...
export const NutritionService = {
  async exculte({
    ...
    try {
      ...
      console.error(error);
      throw new Error("Failed to execute nutrition plan");
    }
